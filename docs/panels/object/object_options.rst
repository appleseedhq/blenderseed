...
- Nested Dielectric Medium Priority:
	- This allows you to set the priority for this object where it intersects with another object.  A higher number equals a lower priority (i.e. 1 takes precedence over 2).  This allows you to correctly render intersecting media like fluid in a glass.
- Ray Bias Method:
